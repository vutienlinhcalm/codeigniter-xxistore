		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
                    <?php 
                        foreach($productdetails as $key => $protail ){
                    ?>
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="<?php echo base_url('uploads/imageproduct/'.$protail->image) ?>" alt="<?php echo $protail->brandname ?>" />
							</div>
					...
					<form action="<?php echo base_url('add-to-cart') ?>" method="POST">
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<h2><?php echo $protail->brandname ?></h2>
                                <p><?php echo $protail->productname  ?></p>
                                <p><b>Gender: </b>
                                    <?php  
                                        if($protail->gender == 0){
                                            echo "Male";
                                        }elseif ($protail->gender == 1)
                                        {
                                            echo "Female";
                                        }else{
                                            echo "Unisex";
